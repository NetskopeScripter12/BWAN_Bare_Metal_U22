...
6) Execute the script in sudouser
```bash
./BWAN_Setup.sh
```
...
```
7) Follow on-screen prompts and wait for completion
8) Install TightVNC (https://www.tightvnc.com/download.php)
9) Open TightVNC and enter in [IP_Address]::9010
10) Gateway is fully operational and ready for configuration!
